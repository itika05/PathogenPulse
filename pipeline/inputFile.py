...
waterSamples = getSamplesName(inDir = "ww_fastqs", suffix = suffix)
waterDat = inputDf(inDir = "ww_fastqs", samplesList = undeterminedSamples)
writeInputDat(df=waterDat, outName="ww_input.csv")
